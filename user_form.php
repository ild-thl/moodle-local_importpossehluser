...
class admin_uploadpossehluser_form1 extends moodleform {
    function definition () {
        ...
        $this->add_action_buttons(false, get_string('uploadusers', 'local_importpossehluser'));
    }
...
class admin_uploadpossehluser_form2 extends moodleform {
    function definition () {
        ...
        $mform->addElement('select', 'uupasswordnew', get_string('uupasswordnew', 'local_importpossehluser'), $choices);
        ...
        $choices = array(0 => get_string('nochanges', 'local_importpossehluser'), 1 => get_string('update'));
        $mform->addElement('select', 'uupasswordold', get_string('uupasswordold', 'local_importpossehluser'), $choices);
        ...
        $mform->addElement('selectyesno', 'uuallowrenames', get_string('allowrenames', 'local_importpossehluser'));
        ...
        $mform->addElement('selectyesno', 'uuallowdeletes', get_string('allowdeletes', 'local_importpossehluser'));
        ...
        $mform->addElement('selectyesno', 'uuallowsuspends', get_string('allowsuspends', 'local_importpossehluser'));
        ...
        if (!empty($CFG->allowaccountssameemail)) {
            $mform->addElement('selectyesno', 'uunoemailduplicates', get_string('uunoemailduplicates', 'local_importpossehluser'));
        ...
        if ($showroles) {
            ...
            $mform->addElement('select', 'uulegacy1', get_string('uulegacy1role', 'local_importpossehluser'), $choices);
            ...
            $mform->addElement('select', 'uulegacy2', get_string('uulegacy2role', 'local_importpossehluser'), $choices);
            ...
            $mform->addElement('select', 'uulegacy3', get_string('uulegacy3role', 'local_importpossehluser'), $choices);
        ...
        // default values
        $mform->addElement('header', 'defaultheader', get_string('defaultvalues', 'local_importpossehluser'));
        ...
        $this->add_action_buttons(true, get_string('uploadusers', 'local_importpossehluser'));
    ...
    function validation($data, $files) {
        ...
        if (!empty($updatetype) && ($optype == UU_USER_ADDNEW || $optype == UU_USER_ADDINC)) {
            $errors['uuupdatetype'] = get_string('invalidupdatetype', 'local_importpossehluser');
        }
        ...
        if ($optype != UU_USER_UPDATE) {
            ...
            if (!in_array('email', $columns) and empty($data['email'])) {
                $errors['email'] = get_string('requiredtemplate', 'local_importpossehluser');
            }
        }
        return $errors;
    }
